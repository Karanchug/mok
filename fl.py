...
TABLE = 'student'
downloaded_file = 'student rd_backup.sql'

def backup(event, context):
    print("Function started")
    dbHost   = "students.chzimgjwsswn.us-east-1.rds.amazonaws.com"
    dbUser   = "admin"
    dbPass   = "Govindam"
    S3_BUCKET = 'sweetypie'
    print(dbHost)
    ...
    command = f"mysql -h {dbHost} -u {dbUser} -p{dbPass} {BACKUP_DATABASE_NAME} < f'C:\\tmp\\{downloaded_file}"
    print(command)
